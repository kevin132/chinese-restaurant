            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <input  readonly type="text" value="" id="h-modal-date">
                  </div>
...
<footer class="h-foot">
    <div class="container">
        <div class="row h-100 ">
          ...
          <div class="col-lg-4 align-self-center text-center ">Evenement</div>
          <div class="col-lg-4  align-self-center text-center">Disponible sur</div>
        </div>
    </div>
</footer>
